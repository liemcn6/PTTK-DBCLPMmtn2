...
<html lang="en">
   ...
   <body>
    <%
for(Sachmuon325 a : list){
            if(a.getNgaytra().after(a.getNgayphaitra())){
                listTramuon.add(a);
            }
        }
        int idpm = listTramuon.get(0).getPhieumuon().getId();
                ...
                <div class="input_area">
                    <div class="form_maSV">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h4 style="color: black; font-size: 16px; position: absolute;right: 90px"> <label style="color: #555; font-size: 15px"> Tên bạn đọc:</label> <%= tbd.getTen().getHodem() + " " + tbd.getTen().getTen()%></h4>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-4">
                                <h4 style="color: black; font-size: 16px; position: absolute;right: 135px"> <label style="color: #555; font-size: 15px">Số điện thoại:</label> <%= tbd.getSdt()%></h4>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-6">
                ...
                <div class="col-md-18">
                    ...
                    <div class="row" style="padding: 0px 50px;justify-content: space-between; width: 100%; margin-top: 50px">
                        ...
                        <%
                            if (!check) {
                        %>
                        <a href="gdchinhnv325.jsp" class="btn bt-lg btn-danger" >Đặt lại</a>
                        <%
                            if(test){
                        %>
                        ...
                        %>
                        <a href="gdtrasach325.jsp" class="btn bt-lg btn-danger" > Lưu </a>
                        <br>
                        <%
                            }
                        %>
