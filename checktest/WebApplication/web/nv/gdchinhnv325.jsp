            ...
            <div class="header" style="background-color: #0f0906" >
                ...
                <div class="page-wrapper">
                    ...
                    <div class="content" style="margin-top: -20px">
                        ...
                        <div class="col-md-6">
                            <div class="row ">
                                <button type="button"  class="btn btn-danger btn-lg btn-block" >Quản lí thẻ bạn đọc</button>
                            </div>
                            <div class="row">
                                <button type="button" class="btn btn-danger btn-lg btn-block" >Quản lí nhà cung cấp</button>
                            </div>
                            <div class="row">
                                <button type="button" class=" btn btn-danger btn-lg btn-block" >Quản lí đầu sách</button>
                            </div>
                            <div class="row">
                                <button type="button" class=" btn btn-danger btn-lg btn-block" >Đổi mật khẩu</button>
                            </div><!-- comment -->
                        </div>
                        <div class="col-md-6">
                            <div class="row ">
                                <button type="button"  class="btn btn-danger btn-lg btn-block"  >Nhập sách</button>
                            </div>
                            <div class="row">
                                <button type="button" class="btn btn-danger btn-lg btn-block"  >Mượn sách</button>
                            </div>
                            <div class="row">
                                <a href="gdquetthe325.jsp" class=" btn btn-danger btn-lg btn-block" >Trả sách</a>
                            </div>
                            <div class="row">
                                <button type="button" class=" btn btn-danger btn-lg btn-block" >Xem thống kê </button>
                            </div><!-- comment -->
