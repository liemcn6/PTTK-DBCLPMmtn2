            ...
            <div class="header" style="background-color: #0f0906" >
                <div class = "img-header bg-primary">
                    ...
                    <div class = "text" style="color: black">
                        <h4>QUÉT MÃ VẠCH THẺ BẠN ĐỌC</h4>
                    </div>
                </div>
            ...
            <div class="page-wrapper">
                ...
                <div class="container_scanner">
                    <div class="input_area">
                        <form class="form_maSV" action="gdtrasach325.jsp" style="margin-top: 30px;height: 120px">
                            <input class="form-control" placeholder="Nhập mã vạch bạn đọc" autofocus style="border-radius: 6px" required type="text" name="mavachBD"/>
                            <div style="margin-top: 50px">
                            <button class="btn bt-lg btn-danger mt-5 float-right" type="button" name="back" onclick="history.back()">Quay lại</button>
                            <button class="btn bt-lg btn-danger mt-5 float-left" type="submit">Tìm kiếm</button>
                            </div>
                        </form>
                    </div>
